    ...
    <footer className="relative bg-slate-950 text-slate-300 overflow-hidden pt-20 pb-10 font-sans">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="font-black text-2xl text-white leading-none tracking-tight">PHYSICS</span>
                <span className="text-[10px] font-bold text-teal-500 tracking-[0.2em] uppercase">MADE EASY</span>
              </div>
            </Link>
            ...
            <div className="flex gap-4">
              {[Facebook, Linkedin, Youtube].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-teal-600 hover:text-white hover:border-teal-600 transition-all duration-300">
          ...
          {/* 2. QUICK LINKS (Synced with Header) */}
          <div>
          ...
          {/* 3. ACADEMIC RESOURCES (Synced with Header) */}
          <div>
            <h3 className="text-white font-bold text-lg mb-6 flex items-center gap-2">
