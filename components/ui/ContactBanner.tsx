...
const PageBanner: React.FC<PageBannerProps> = ({
  title = "Contact",
  highlight = "Us",
  description = "Have questions about Physics or Chess? We're here to help.",
  currentPage = "Contact"
}) => {
  return (
    <div className="relative w-full bg-slate-50 overflow-hidden pt-32 pb-20 lg:pt-14 lg:pb-6 font-sans">
