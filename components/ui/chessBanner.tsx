...
import { Home, ChevronRight, BookOpen, Sparkles, Atom, Target } from 'lucide-react';

const CoursesBanner: React.FC = () => {
  return (
    <div className="relative w-full bg-slate-50 overflow-hidden pt-32 pb-20 lg:pt-10 lg:pb-12 font-sans">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight relative">
          Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-indigo-600">Courses</span>
